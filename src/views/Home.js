    ...
    return (
      <div className="home">
        ...
        >
            ...
            <div className="iconsContainer">
              ...
              <div className="iconContainer" style={{ animationDelay: '0.1s' }}>
                <SvgIcon style={{ width: '100%', height: '100%' }}>
                  ...
                  >
                    <path
                      d="M12,62A50,50,0,0,1,12-38a49.84,49.84,0,0,1,6.62.49C-1.87-34.07-16.29-21-22.64-6.1c-12.24,28.72,6.8,51.74,28,51.71,13.73,0,25.76-9.27,32.92-21,6.68-11,14.17-12.92,18.53-11.28a6.72,6.72,0,0,1,4.43,7.14A50,50,0,0,1,12,62M61.37,4.46C49.48-.92,37.15,7.23,29.74,19.4c-5,8.26-12.22,14-19.7,15.68C-6.76,38.9-23.38,21.15-13.43-2.18c6.71-15.74,25.6-31.46,56.93-24.63A49.93,49.93,0,0,1,61.37,4.45M72,12A60,60,0,1,0,12,72,60.11,60.11,0,0,0,72,12"
              ...
              <div className="iconContainer" style={{ animationDelay: '0.2s' }}>
                <SvgIcon style={{ width: '100%', height: '100%' }}>
                  ...
                  >
                    <path
                      d="M-23-23H-38v-5h15ZM17,2A15,15,0,1,0,32,17,15,15,0,0,0,17,2ZM72-18V57H-48V-18h29.65A10,10,0,0,0-10-22.45L-3-33H37l7,10.54A10,10,0,0,0,52.35-18ZM-23,2a5,5,0,0,0-5-5,5,5,0,0,0-5,5,5,5,0,0,0,5,5A5,5,0,0,0-23,2ZM42,17A25,25,0,1,0,17,42,25,25,0,0,0,42,17Z"
          ...
          <LinkedInIconButton
            themeType={themeType}
            href="https://linkedin.com/in/hadi-ghattas"
            target="_blank"
          />
          <TwitterIconButton
            themeType={themeType}
            href="https://twitter.com/hadighattas"
            target="_blank"
          />
          <InstagramIconButton
            themeType={themeType}
            href="https://instagram.com/hadighattas"
            target="_blank"
          />
        </Paper>
        ...
        <Button
          variant="contained"
          color="secondary"
          href="https://github.com/hadighattas"
          target="_blank"
        >
